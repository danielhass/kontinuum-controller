...
func (mc ManagedComponent) ToComponent() Component {
	return Component{
		Name:   mc.Name,
		Type:   mc.Type,
		Values: nil,
...
type WorkloadSpec struct {
	...
	// Components of this workload
	Components []Component `json:"components"`
	// Managed components of this workload
	ManagedComponents []ManagedComponent `json:"managedComponents"`
	// Label selector for targets
